...
export const countryPools: Record<number, Country[]> = {
  1: [
    ...
    { name: 'Singapore', code: 'SGP', continent: 'Asia', coordinates: { latitude: 1.3, longitude: 103.8 }, isSmall: true },
    ...
    { name: 'Israel', code: 'ISR', continent: 'Asia', coordinates: { latitude: 31, longitude: 34 }, isSmall: true },
  ...
  2: [
    ...
    { name: 'Jamaica', code: 'JAM', continent: 'North America', coordinates: { latitude: 18.1, longitude: -77.2 }, isSmall: true },
    ...
    { name: 'Lebanon', code: 'LBN', continent: 'Asia', coordinates: { latitude: 33.8, longitude: 35.8 }, isSmall: true },
  ...
  3: [
    ...
    { name: 'Kuwait', code: 'KWT', continent: 'Asia', coordinates: { latitude: 29.3, longitude: 47.5 }, isSmall: true },
    { name: 'Oman', code: 'OMN', continent: 'Asia', coordinates: { latitude: 21, longitude: 56 } },
    { name: 'Qatar', code: 'QAT', continent: 'Asia', coordinates: { latitude: 25.3, longitude: 51.5 }, isSmall: true },
    { name: 'Bahrain', code: 'BHR', continent: 'Asia', coordinates: { latitude: 26, longitude: 50.5 }, isSmall: true },
  ...
  4: [
    ...
    { name: 'Fiji', code: 'FJI', continent: 'Oceania', coordinates: { latitude: -18, longitude: 175 }, isSmall: true },
    { name: 'Haiti', code: 'HTI', continent: 'North America', coordinates: { latitude: 19, longitude: -72.4 }, isSmall: true },
    ...
    { name: 'Bahamas', code: 'BHS', continent: 'North America', coordinates: { latitude: 24.2, longitude: -76 }, isSmall: true },
    { name: 'Barbados', code: 'BRB', continent: 'North America', coordinates: { latitude: 13.1, longitude: -59.5 }, isSmall: true },
    { name: 'Trinidad and Tobago', code: 'TTO', continent: 'North America', coordinates: { latitude: 11, longitude: -61 }, isSmall: true },
    { name: 'Cyprus', code: 'CYP', continent: 'Europe', coordinates: { latitude: 35, longitude: 33 } }
  ],
  5: [
    { name: 'Malta', code: 'MLT', continent: 'Europe', coordinates: { latitude: 35.9, longitude: 14.4 }, isSmall: true },
    ...
    { name: 'Monaco', code: 'MCO', continent: 'Europe', coordinates: { latitude: 43.7, longitude: 7.4 }, isSmall: true },
    { name: 'San Marino', code: 'SMR', continent: 'Europe', coordinates: { latitude: 43.9, longitude: 12.4 }, isSmall: true },
    { name: 'Liechtenstein', code: 'LIE', continent: 'Europe', coordinates: { latitude: 47.1, longitude: 9.5 }, isSmall: true },
    { name: 'Vatican City', code: 'VAT', continent: 'Europe', coordinates: { latitude: 41.9, longitude: 12.4 }, isSmall: true },
    { name: 'Luxembourg', code: 'LUX', continent: 'Europe', coordinates: { latitude: 49.8, longitude: 6.1 } },
    { name: 'Cabo Verde', code: 'CPV', continent: 'Africa', coordinates: { latitude: 16, longitude: -24 }, isSmall: true },
    { name: 'Sao Tome and Principe', code: 'STP', continent: 'Africa', coordinates: { latitude: 1, longitude: 7 }, isSmall: true },
    { name: 'Comoros', code: 'COM', continent: 'Africa', coordinates: { latitude: -12.2, longitude: 44.2 }, isSmall: true },
    { name: 'Seychelles', code: 'SYC', continent: 'Africa', coordinates: { latitude: -4.6, longitude: 55.4 }, isSmall: true },
    { name: 'Mauritius', code: 'MUS', continent: 'Africa', coordinates: { latitude: -20.3, longitude: 57.5 }, isSmall: true },
    { name: 'Antigua and Barbuda', code: 'ATG', continent: 'North America', coordinates: { latitude: 17.1, longitude: -61.8 }, isSmall: true },
    { name: 'Saint Kitts and Nevis', code: 'KNA', continent: 'North America', coordinates: { latitude: 17.3, longitude: -62.7 }, isSmall: true },
    { name: 'Dominica', code: 'DMA', continent: 'North America', coordinates: { latitude: 15.4, longitude: -61.3 }, isSmall: true },
    { name: 'Saint Lucia', code: 'LCA', continent: 'North America', coordinates: { latitude: 13.9, longitude: -60.9 }, isSmall: true },
    { name: 'Saint Vincent and the Grenadines', code: 'VCT', continent: 'North America', coordinates: { latitude: 13.2, longitude: -61.2 }, isSmall: true },
    { name: 'Grenada', code: 'GRD', continent: 'North America', coordinates: { latitude: 12.1, longitude: -61.6 }, isSmall: true },
    { name: 'Samoa', code: 'WSM', continent: 'Oceania', coordinates: { latitude: -13.7, longitude: -172.1 }, isSmall: true },
    { name: 'Tonga', code: 'TON', continent: 'Oceania', coordinates: { latitude: -21.1, longitude: -175.2 }, isSmall: true },
    { name: 'Tuvalu', code: 'TUV', continent: 'Oceania', coordinates: { latitude: -8.5, longitude: 179.2 }, isSmall: true },
    { name: 'Kiribati', code: 'KIR', continent: 'Oceania', coordinates: { latitude: 1.4, longitude: 173 }, isSmall: true },
    { name: 'Marshall Islands', code: 'MHL', continent: 'Oceania', coordinates: { latitude: 7.1, longitude: 171.3 }, isSmall: true },
    { name: 'Micronesia', code: 'FSM', continent: 'Oceania', coordinates: { latitude: 6.9, longitude: 158.1 }, isSmall: true },
    { name: 'Nauru', code: 'NRU', continent: 'Oceania', coordinates: { latitude: -0.5, longitude: 166.9 }, isSmall: true },
    { name: 'Palau', code: 'PLW', continent: 'Oceania', coordinates: { latitude: 7.5, longitude: 134.6 }, isSmall: true },
    { name: 'Solomon Islands', code: 'SLB', continent: 'Oceania', coordinates: { latitude: -9, longitude: 160 }, isSmall: true },
    { name: 'Vanuatu', code: 'VUT', continent: 'Oceania', coordinates: { latitude: -16, longitude: 167 }, isSmall: true },
    ...
    { name: 'Palestine', code: 'PSE', continent: 'Asia', coordinates: { latitude: 31.9, longitude: 35.2 }, isSmall: true },
    ...
    { name: 'Maldives', code: 'MDV', continent: 'Asia', coordinates: { latitude: 3.2, longitude: 73 }, isSmall: true },
  ...
  6: [
    ...
    { name: 'Armenia', code: 'ARM', continent: 'Asia', coordinates: { latitude: 40, longitude: 45 } },
    { name: 'Azerbaijan', code: 'AZE', continent: 'Asia', coordinates: { latitude: 40.5, longitude: 47.5 } },
    { name: 'Cyprus', code: 'CYP', continent: 'Europe', coordinates: { latitude: 35, longitude: 33 }, isSmall: true },
    { name: 'Iceland', code: 'ISL', continent: 'Europe', coordinates: { latitude: 64.9, longitude: -18.1 } },
    { name: 'Luxembourg', code: 'LUX', continent: 'Europe', coordinates: { latitude: 49.8, longitude: 6.1 }, isSmall: true },
    { name: 'Andorra', code: 'AND', continent: 'Europe', coordinates: { latitude: 42.5, longitude: 1.5 }, isSmall: true }
  ],
  7: [
    { name: 'Jordan', code: 'JOR', continent: 'Asia', coordinates: { latitude: 31, longitude: 36 } },
    { name: 'Iraq', code: 'IRQ', continent: 'Asia', coordinates: { latitude: 33, longitude: 44 } },
  ...
  9: [
    ...
    { name: 'Ivory Coast', code: 'CIV', continent: 'Africa', coordinates: { latitude: 8, longitude: -5 } },
    { name: 'Cameroon', code: 'CMR', continent: 'Africa', coordinates: { latitude: 6, longitude: 12 } },
    { name: 'Senegal', code: 'SEN', continent: 'Africa', coordinates: { latitude: 14.5, longitude: -14.4 } },
    { name: 'Mali', code: 'MLI', continent: 'Africa', coordinates: { latitude: 17, longitude: -4 } },
    { name: 'Niger', code: 'NER', continent: 'Africa', coordinates: { latitude: 16, longitude: 8 } },
    { name: 'Burkina Faso', code: 'BFA', continent: 'Africa', coordinates: { latitude: 13, longitude: -2 } },
    { name: 'Chad', code: 'TCD', continent: 'Africa', coordinates: { latitude: 15, longitude: 19 } },
...
export function initializeGame(): Country[][] {
  return [
    ...
    selectRandomCountries(6),
    selectRandomCountries(7),
    selectRandomCountries(8),
    selectRandomCountries(9),
    selectRandomCountries(10),
  ];
}